...
public enum PRICING {
	UPWARDS {
		...
		public Bid currentBid(List<Bid> bids) {
			/*
			 * Bid curr = null; for(Bid bid : bids){ if(curr == null){ curr = bid; }else{
			 * if(bid.getPrice().compareTo(curr.getPrice())>0){ curr = bid; } } } return
			 * curr;
			 */
			...
			/*
			 * return Collections.max(bids,new Comparator<Bid>() { public int compare(Bid
			 * o1, Bid o2) { return o1.getPrice().compareTo(o2.getPrice()); } });
			 */
		}
